...
<body id="pagebody" runat="server" OnPreRender="PageBody_PreRender">
    <form id="form1" runat="server">
        <div class="auto-style4">
            ...
            <br />
            </span><span class="auto-style6"><strong>go deploy Traffic Manager Web App</strong></span><span class="auto-style1"><br class="auto-style7" />
            ...
            <br />
            <br />
            <asp:Image ID="Image1" runat="server" ImageUrl="~/Images/godlogo.png" />
        </div>
    </form>
</body>
</html>
